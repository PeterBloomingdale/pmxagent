# PMxAgent Contributor License Agreement (CLA)

This Contributor License Agreement ("Agreement") applies to all non-trivial contributions submitted to PMxAgent.
...
- The contribution is an original work of authorship by the Contributor, or the Contributor otherwise has sufficient rights to submit and assign it.
- The Contributor has the legal authority to enter into this Agreement for themselves or on behalf of the entity they represent.
...
The Contributor acknowledges that PMxAgent is distributed publicly under `AGPL-3.0-only` (see `LICENSE`).

## 5. How to Agree (GitHub PR Comment)

To accept this Agreement, the Contributor must post the following exact statement as a comment on their pull request:

`I have read the CLA and agree to its terms.`

Maintainers may treat that statement as an electronic signature to this Agreement.

## 6. Governing Law

This Agreement is governed by the laws of the State of California, USA, without regard to its conflict-of-law provisions.

## 7. Miscellaneous

- This Agreement is irrevocable for accepted contributions.
